...
You can create explicit anchors like \[anchor-21\]\# or link to existing sections like [the Code Blocks Section](#Xe611057f21698f1380825caf8514c0f5e58b1b0).

Here is a sentence with an inline footnote \[[1](#_footnotedef_1 "View footnote.")\].

And another reference to a second footnote \[[2](#_footnotedef_2 "View footnote.")\].
...
[1](#_footnoteref_1). This is the text of the footnote rendered at the bottom of the document or section.

[2](#_footnoteref_2). Footnotes can also have explicit identifiers for reusability.